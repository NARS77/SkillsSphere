...
class DiscussionThread(BaseBusinessModel):
    course = models.ForeignKey("courses.Course", on_delete=models.CASCADE, related_name="discussion_threads")
...
class ThreadVote(BaseBusinessModel):
    thread = models.ForeignKey(DiscussionThread, on_delete=models.CASCADE, related_name="votes")
