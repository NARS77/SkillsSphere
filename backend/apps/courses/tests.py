...
class CourseAPITests(APITestCase):
    def setUp(self):
        ...
        # Create category
        self.category = Category.objects.create(name="Web Development", icon="code", color="indigo", order=1)
        self.category2 = Category.objects.create(name="Data Science", icon="database", color="emerald", order=2)
    ...
    def test_other_instructor_cannot_modify_course(self):
        ...
        course = Course.objects.create(title="Instructor 1 Course", instructor=self.instructor)
    ...
    def test_safe_deletion_draft_only(self):
        ...
        draft_course = Course.objects.create(
            title="Draft Course", instructor=self.instructor, status=Course.Status.DRAFT
        )
