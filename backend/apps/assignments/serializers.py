...
class AssignmentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Assignment
        fields = [
            'id', 'course', 'lesson', 'title', 'instructions', 
            'due_date', 'max_score', 'rubric', 
            'late_submission_rule', 'late_penalty_percentage'
        ]
...
class AssignmentSubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'file', 'github_repo_url', 'text_submission', 'status', 
            'score', 'feedback', 'rubric_scoring', 
