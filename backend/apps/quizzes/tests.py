...
class AssessmentAPITests(APITestCase):
    def setUp(self):
        ...
        self.course = Course.objects.create(
            title="Django Advanced Development", instructor=self.instructor, status=Course.Status.PUBLISHED
        )
        ...
        self.lesson = Lesson.objects.create(
            section=self.section, title="Lesson 1", lesson_type=Lesson.LessonType.QUIZ, status=Lesson.Status.PUBLISHED
        )
    ...
    def test_quiz_attempt_scoring_logic(self):
        ...
        q1 = Question.objects.create(
            quiz=quiz, question_type=Question.QuestionType.SINGLE, prompt="What is Django?", weight=10.0
        )
        ...
        q2 = Question.objects.create(
            quiz=quiz, question_type=Question.QuestionType.FILL, prompt="Django uses M_C architecture.", weight=10.0
        )
