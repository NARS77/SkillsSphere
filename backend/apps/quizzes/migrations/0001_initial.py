    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('SINGLE', 'Multiple Choice (Single Answer)'), ('MULTI', 'Multiple Choice (Multiple Answers)'), ('TF', 'True / False'), ('SHORT', 'Short Answer'), ('FILL', 'Fill in the Blank'), ('MATCH', 'Matching'), ('ORDER', 'Ordering'), ('PREDICT', 'Code Output Prediction')], default='SINGLE', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quiz', to='curriculum.lesson')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('STARTED', 'Started'), ('IN_PROGRESS', 'In Progress'), ('SUBMITTED', 'Submitted')], default='STARTED', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordering_answer', models.JSONField(blank=True, help_text="JSON list of option IDs in student's order", null=True)),
                ('matching_answer', models.JSONField(blank=True, help_text='JSON dict mapping option ID to matching answer text', null=True)),
