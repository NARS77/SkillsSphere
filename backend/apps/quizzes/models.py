...
class AnswerOption(UUIDModel):
    ...
    match_text = models.TextField(blank=True, default='', help_text="For matching questions, the correct match on the right side")
...
class QuestionAttempt(UUIDModel):
    ...
    matching_answer = models.JSONField(null=True, blank=True, help_text="JSON dict mapping option ID to matching answer text")
