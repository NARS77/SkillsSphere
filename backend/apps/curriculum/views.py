...
class SectionViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        section = service.create_section(
            course_id=course_id, title=serializer.validated_data["title"], user=request.user
        )
    ...
    def update(self, request, *args, **kwargs):
        ...
        section = service.update_section(
            section_id=instance.id, title=serializer.validated_data["title"], user=request.user
        )
...
class LessonViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        service = CurriculumService()
        lesson = service.create_lesson(section_id=section_id, data=serializer.validated_data, user=request.user)
    ...
    def update(self, request, *args, **kwargs):
        ...
        service = CurriculumService()
        lesson = service.update_lesson(lesson_id=instance.id, data=serializer.validated_data, user=request.user)
...
class LessonResourceViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        service = CurriculumService()
        resource = service.create_resource(lesson_id=lesson_id, title=title, file_obj=file_obj, user=request.user)
